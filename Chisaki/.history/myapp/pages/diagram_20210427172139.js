    ...
    return (
      ...
      />
        ...
        <PicBtn6 className={styles.humanbtn}
          ...
          content={<div><strong className="highlight">Tensed Muscle:</strong> Stress makes muscle tense up, and chronic stress leads to tension-related headache and backaches</div>}
          />
      <br></br>
