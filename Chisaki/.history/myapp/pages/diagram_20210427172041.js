    ...
    return (
      ...
      />
        ...
        <PicBtn6 className={styles.humanbtn}
          ...
          content={<div><strong style=color="#000000">Tensed Muscle:</strong> Stress makes muscle tense up, and chronic stress leads to tension-related headache and backaches</div>}
          />
      <br></br>
