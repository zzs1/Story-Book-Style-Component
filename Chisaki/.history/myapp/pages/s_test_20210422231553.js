...
export default function Suggest() {
  return (
    ...
    routeTo="/instruction"
    Pstyle= "There are totall 6 questions in the app to scale your mental illness level. Based on your answers, the app will show you the percentage of the possibility of serverving mental "
    visivility="hidden"
    />
    </div>
