...
export default function Suggest() {
  return (
    ...
    routeTo="/instruction"
    Pstyle= "After taking the 6 questions, the app will show you the result of your mental illness level with 3 types which are Anxiety disorder, Bipolator disorder, and "
    visivility="hidden"
    />
