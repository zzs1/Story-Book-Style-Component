...
const EnlargedUI = ({
    ...
    <Ps>{Pstyle}<br /><br /></Ps>
    <Ps>    Pstyle= "Our research team include professional psychologist, by study the experiences of client, we gather those information to make the suggestion part.",
    Pstyle2="The suggestion part Including:"</Ps>
