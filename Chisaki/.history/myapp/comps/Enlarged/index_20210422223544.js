...
const EnlargedUI = ({
    ...
    src="",
    routeTo="",
    Pstyle= "Our research team include professional psychologist, by study the experiences of client, we gather those information to make the suggestion part. The suggestion part Including:",
