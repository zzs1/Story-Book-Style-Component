...
export default function Intro() {
    return (
      <div className={styles.base}>
        ...
        />
        <J_Content 
        content="In Retheraphy, the small scale test helps user to check their mental condition by analysis test answer and evaluate the possible chance of suffering from top 3 mental illnesses ."
        />
