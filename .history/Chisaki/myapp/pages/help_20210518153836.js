...
export default function Terms() {
    return (
      <div className={styles.base}>
        ...
        content={<div>They offer a safe and confidential place to talk or text in your way. They can help you to understand your thoughts and feelings and connect you with local support resources.
          <div className={styles.helpphone}>
