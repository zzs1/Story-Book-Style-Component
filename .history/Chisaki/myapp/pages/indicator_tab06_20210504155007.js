...
export default function Indicator_tab06() {
    return (
          ...
          <TopBar/>
            ...
            <TabInfo01 
            src="../../logo/06.png"
            content={<div><p></p>Explosive eruptions occur suddenly, with little or no warning, and usually last for a short time. This may occur frequently. Less severe verbal outbursts may occur in between episodes of physical aggression. You may be<span className={styles.span}> irritable, impulsive, aggressive, or chronically angry most of the time.</span></div>}
            />
