...
export default function Suggestion_06() {
    return (
          ...
          <TopBar/>
            ...
            content={<div><p>By talking your concerns to someone else, you can organize your feeling. Moreover, someone may give you some advice for your concerns. <span className={styles.span}></span>It is always a good idea to talk your feelings to people you trust. If your concerns are really personal ones, you can also reach out to some professional consultants.</p></div>}
            />
