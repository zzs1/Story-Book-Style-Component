...
export default function Terms() {
    return (
      <div className={styles.base}>
        ...
        content={<div>Offer a safe, confidential place to talk or text in your own way. They can help you understand your thoughts and feelings, and connect you with local support resources. You can share your difficult moment with you.
