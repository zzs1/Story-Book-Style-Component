...
export default function Indicator_tab08() {
    return (
          ...
          <TopBar/>
            ...
            <TabInfo01 
            src="../../logo/08.png"
            content={<div><p>Personality change refers to<span className={styles.span}>a shift in the way you think, act, or feel.</span> A sudden, undesired, or uncontrollable change in your personality may be a sign of a serious condition. Personality changes may be 
