...
export default function Indicator_tab03() {
    return (
          ...
          <TopBar/>
            ...
            <TabInfo01 
            src="../../logo/03.png"
            contnet={<div><p> Depression is a common medical illness that<span className={styles.span}>negatively affects how you feel, the way you think, and how you act. </span>
