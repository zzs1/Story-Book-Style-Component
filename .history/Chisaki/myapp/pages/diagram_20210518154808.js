    ...
    return (
      ...
      />
        ...
        <PicBtn1 className={styles.humanbtn} 
          ...
          content={<div><strong className={styles.highlight}>Headache:</strong> stress can trigger and intensity tension headaches</div>}
          />
        ...
        <PicBtn2 className={styles.humanbtn}
          ...
          content={<div><strong className={styles.highlight}>Heartburn:</strong> stress increases the production of stomach acid, which could lead to heartburn or make it worse</div>}
          />
        ...
        <PicBtn3 className={styles.humanbtn}
          ...
          content={<div><strong className={styles.highlight}>Rapid breathing:</strong> The tensed muscle at the lung cause rapid breath and short-take of breathing. Which proves to be dangerous</div>}
          />
        ...
        <PicBtn4 className={styles.humanbtn}
          ...
          content={<div><strong className={styles.highlight}>Weaken immune system:</strong> Long term stress and irritation weaken your immune system and open you for infection</div>}
          />
        ...
        <PicBtn5 className={styles.humanbtn}
          ...
          content={<div><strong className={styles.highlight}>Stomachache:</strong> stress affects your body’s digestive system, which can lead to stomachaches and other tummy troubles</div>}
          />
