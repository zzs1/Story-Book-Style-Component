...
export default function Test() {
  return (
    ...
    subtext=""
    routeTo=""
    Pstyle= {We provide suggestions that help to improve your mental health. Our suggestions are based on the study and research. To check our suggestions, please click SEE SUGGESTION Button."
    />
    </div>
