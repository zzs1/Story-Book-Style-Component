...
export default function Terms() {
    return (
      <div className={styles.base}>
        ...
        content="offer a safe, confidential place to talk or text in your own way.They can help you understand your thoughts and feelings, and connect you with local support resources. But ultimately we are here to listen and share this difficult moment with you. "/>
        <HelpBoxUI 
        number="3"
