...
export default function Test() {
  return (
    ...
    subtext=""
    routeTo=""
    Pstyle= "We provide suggestions that help improving your mental health. Our suggestions are based on the study and research. To check our suggestions, please clicking SEE SUGGETION Button."
    />
    </div>
