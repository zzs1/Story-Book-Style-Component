...
export default function Intro() {
    return (
      <div className={styles.base}>
        ...
        <J_Content
        content="Retheraphy comes from the word therapist, and our goal is to be your therapist that shows the potential illnesses you may have and improve you mental health."
        />
        <J_Content 
