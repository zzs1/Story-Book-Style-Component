...
export default function Suggestion_07() {
    return (
          ...
          <TopBar/>
            ...
            content={<div><p>You may reduce the impact of your mental illness by managing time and energy. Cut back on obligations when necessary and set reasonable goals. <span className={styles.span}></span>You may find it helpful to make a list of daily tasks or use a planner to structure your time and stay organized.</p></div>}
            />
